    ...
    return(<>
        <div class="contact__container bd-grid">
                <h2 class="section-title">Contact</h2>
                    ...
                    <input  value={SleepDuration} onChange={handileSleepDueration} id="Sleep Duration " placeholder='Sleep Duration (eg: 7.5/10)' />
                    <input  value={QualityOfSleep} onChange={handileQualityOfSleep} id="Quality of sleep " placeholder='Quality of sleep (eg: 6/10)' />
                    <input  value={PhysicalActivity} onChange={handilePhysicalActivity} id="physical activiyt" placeholder="Physical Activity" type='text (how many times[mentioned in numbers])' />
                    <input  value={StressLevel} onChange={handileStressLevel} id="Stress Level " placeholder='Stress Level (7/10)' />
                    <input  value={BMICatagory} onChange={handileBMICatagory}id="BMI Category " placeholder='BMI Category (normal,over weight,obese,normal weight)' />
                    <input  value={HeartRate} onChange={handileHeartRate}id="Heart Rate" placeholder='Heart Rate (eg: 94)' />
